{
  ...
  rubocop-rails_config = {
    dependencies = ["railties" "rubocop" "rubocop-ast" "rubocop-md" "rubocop-minitest" "rubocop-packaging" "rubocop-performance" "rubocop-rails"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1zdbkzkgizg6jri2xkszi3wiygimgvpivn6hmsnys74vfm1wrnx5";
      target = "ruby";
      type = "gem";
    };
    targets = [];
