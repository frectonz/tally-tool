{
  ...
  nokogiri = {
    ...
    targets = [{
      ...
      {
        remotes = [ "https://rubygems.org" ];
        sha256 = "1my55dpyz0rphaxv3miz04lv3cg609wf4sj8gyyxwd00aif60mnp";
  ...
  rubocop-rails_config = {
    dependencies = [ "rubocop" "rubocop-ast" "rubocop-md" "rubocop-minitest" "rubocop-packaging" "rubocop-performance" "rubocop-rails" ];
    groups = [ "development" "test" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "0dd5676008fhgascahiafg980symvs892crx0lpnqrw7diddj3xf";
      target = "ruby";
      type = "gem";
    };
    targets = [ ];
  ...
  sqlite3 = {
    ...
    targets = [{
      remotes = [ "https://rubygems.org" ];
      sha256 = "0fqykiys578zg9ygp05i382iclk7f3wny4pmmr4cam1jqj6sa7k5";
      target = "x86_64-darwin";
      targetCPU = "x86_64";
      targetOS = "darwin";
      type = "gem";
      ...
      {
        remotes = [ "https://rubygems.org" ];
        sha256 = "0h4irjccgn86zvdy6p9whzh57wsrd6c6h9fqh3l9c7p7aj6i49bw";
        target = "arm64-darwin";
        targetCPU = "arm64";
        targetOS = "darwin";
        type = "gem";
